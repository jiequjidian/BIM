...
public class SqlHelper
{
    ...
    public static string connectionString = "server=127.0.0.1;uid=sa;pwd=123456789;database=DisplayPlatform";
    ...
    public static DataSet QueryDataSet(string SQLString, string TableName)
    {
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            DataSet ds = new DataSet();
    ...
    public static DataSet QueryDataSet(string SQLString, string TableName, string TableName1)
    {
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            DataSet ds = new DataSet();
    ...
            /// <returns></returns>
    public static DataSet QueryDataSet(string SQLString, int Times)
    {
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            DataSet ds = new DataSet();
