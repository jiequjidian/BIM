...
namespace SocketService
{
    public class LogHelper
    {
        ...
        {
            Log.Debug("日志记录:" + write + "。错误：" + ex.ToString());
        }
        #endregion
        ...
        {
            Log.Info("日志记录:" + write + "。错误：" + ex.ToString());
        }
        #endregion
        ...
        {
            Log.Warn("日志记录:" + write + "。错误：" + ex.ToString());
        }
        #endregion
        ...
        {
            Log.Error("日志记录:" + write + "。错误：" + ex.ToString());
        }
        #endregion
        ...
        {
            Log.Fatal("日志记录:" + write + "。错误：" + ex.ToString());
        }
        //#endregion
